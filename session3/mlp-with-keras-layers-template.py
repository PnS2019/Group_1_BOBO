...
# define a model
# >>>>> PUT YOUR CODE HERE <<<<<
x = Input((458,))  # the input feature has 458 values
y = Dense(200, activation="tanh")(x) #first layer tanh is best due to our observations
y = Dense(200, activation="tanh")(y) #second layer
y = Dense(num_classes, activation="softmax")(y) #Last layer => SOftmax, for classification
